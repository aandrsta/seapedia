...
<div class="max-w-2xl">
    <div class="card p-8 bg-white border border-sand-300 shadow-warm">
        ...
        <form action="{{ route('seller.products.update', $product->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="name" name="name" 
                       ...
                       placeholder="Contoh: Kamera DSLR Nikon D7500" required>
                @error('name')
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4" 
                          ...
                          placeholder="Jelaskan kondisi barang, kelengkapan, garansi, dll...">{{ old('description', $product->description) }}</textarea>
                @error('description')
                    <p class="form-error">{{ $message }}</p>
                @enderror
            </div>
