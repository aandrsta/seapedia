...
<div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
    ...
    <div class="h-16 flex items-center justify-between px-6 bg-navy-800 border-b border-navy-600/30">
        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-1.5 shrink-0">
    ...
    <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
        <!-- Common Link -->
        <a href="<?php echo e(route('home')); ?>" class="sidebar-item hover:bg-navy-600">
        ...
        <?php if($role === 'admin'): ?>
            <a href="<?php echo e(route('dashboard.admin')); ?>" class="sidebar-item <?php echo e(request()->routeIs('dashboard.admin') ? 'sidebar-item-active' : ''); ?>">
        ...
        <?php elseif($role === 'buyer'): ?>
            <a href="<?php echo e(route('dashboard.buyer')); ?>" class="sidebar-item <?php echo e(request()->routeIs('dashboard.buyer') ? 'sidebar-item-active' : ''); ?>">
        ...
        <?php elseif($role === 'seller'): ?>
            <a href="<?php echo e(route('dashboard.seller')); ?>" class="sidebar-item <?php echo e(request()->routeIs('dashboard.seller') ? 'sidebar-item-active' : 'hover:bg-navy-600'); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                Profil Toko
            </a>
            <a href="<?php echo e(route('seller.products.index')); ?>" class="sidebar-item <?php echo e(request()->routeIs('seller.products.*') ? 'sidebar-item-active' : 'hover:bg-navy-600'); ?>">
        ...
        <?php elseif($role === 'driver'): ?>
            <a href="<?php echo e(route('dashboard.driver')); ?>" class="sidebar-item <?php echo e(request()->routeIs('dashboard.driver') ? 'sidebar-item-active' : ''); ?>">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                Ikhtisar Driver
            </a>
            <a href="#" class="sidebar-item opacity-50 cursor-not-allowed">
    ...
    <div class="p-4 bg-navy-800 border-t border-navy-600/30 flex items-center justify-between">
        <div class="flex items-center gap-3 min-w-0">
            ...
            <div class="min-w-0">
                <p class="text-sm font-bold truncate leading-tight"><?php echo e(auth()->user()->name); ?></p>
                <p class="text-xs text-navy-300 truncate leading-none mt-1">@ <?php echo e(auth()->user()->username); ?></p>
            </div>
        </div>
...
<?php /**PATH /home/dini/Sites/seapedia/resources/views/components/sidebar.blade.php ENDPATH**/ ?>