    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 gap-4">
            ...
            <div class="flex items-center shrink-0">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-0.5">
            ...
            <div class="flex-grow max-w-2xl hidden md:block">
                <form action="<?php echo e(route('products.index')); ?>" method="GET" class="relative group" id="navbar-search-form">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?php echo e(auth()->check() ? '#' : route('login')); ?>" id="navbar-cart-btn" class="relative p-2 text-navy-800 hover:text-teal-600 transition-colors" title="Keranjang">
                ...
                <?php if(auth()->guard()->check()): ?>
                        ...
                        >
                            ...
                            <div class="px-4 py-4 bg-gradient-to-br from-teal-600 to-teal-700 relative overflow-hidden">
                                ...
                                <div class="relative flex items-center gap-3">
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-white font-black text-sm leading-tight truncate"><?php echo e(auth()->user()->name); ?></p>
                                        <p class="text-teal-100 text-[10px] font-medium truncate"> <?php echo e('@' . auth()->user()->username); ?></p>
                                    </div>
                                </div>
                                <?php if(session('active_role')): ?>
                                    <div class="relative mt-3">
                                        <span class="inline-flex items-center gap-1 text-[9px] font-black uppercase tracking-widest bg-white/20 text-white border border-white/20 px-2 py-0.5 rounded-full">
                                            ...
                                            <?php echo e(session('active_role')); ?>
                            ...
                            <div class="py-2">
                                ...
                                <?php if(in_array(session('active_role'), ['seller', 'driver', 'admin'])): ?>
                                <!-- Dashboard -->
                                <a href="<?php echo e(route('dashboard.' . session('active_role'))); ?>"
                                   @click="profileOpen = false"
                                   class="flex items-center gap-3 px-4 py-3 text-xs font-bold text-navy-800 hover:bg-sand-50 hover:text-teal-700 transition-colors group">
                                    <span class="w-8 h-8 rounded-[10px] bg-sand-100 group-hover:bg-teal-100 flex items-center justify-center transition-colors shrink-0">
                                        <svg class="w-4 h-4 text-navy-600 group-hover:text-teal-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[10px] font-medium text-sand-400 mt-0.5">Panel <?php echo e(ucfirst(session('active_role'))); ?></p>
                                    </div>
                                </a>
                                <?php endif; ?>
                    ...
                    <?php if(auth()->user()->roles->count() > 1): ?>
                        <a href="<?php echo e(route('select-role')); ?>" class="p-1.5 text-navy-800 hover:text-teal-600 hover:bg-sand-50 transition-all" title="Pindah Peran">
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('login')); ?>" id="navbar-login-btn" class="btn btn-ghost text-[10px] font-black uppercase tracking-widest border border-sand-300 hover:border-navy-900 text-navy-900">MASUK</a>
                    <a href="<?php echo e(route('register')); ?>" id="navbar-register-btn" class="btn btn-primary text-[10px] font-black uppercase tracking-widest">DAFTAR</a>
                <?php endif; ?>
    ...
    <div x-show="mobileOpen" x-cloak
        ...
        <div class="px-4 py-4 space-y-3">
            ...
            <div class="flex flex-col gap-1 pt-2">
                <a href="<?php echo e(route('products.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-xs font-black uppercase tracking-widest text-navy-900 hover:bg-sand-50 transition-colors">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(in_array(session('active_role'), ['seller', 'driver', 'admin'])): ?>
                        <a href="<?php echo e(route('dashboard.' . session('active_role'))); ?>" class="flex items-center gap-3 px-3 py-2.5 text-xs font-black uppercase tracking-widest text-navy-900 hover:bg-sand-50 transition-colors">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('profile')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-xs font-black uppercase tracking-widest text-navy-900 hover:bg-sand-50 transition-colors">
                ...
                <?php else: ?>
                    <div class="flex gap-2 pt-2">
                        <a href="<?php echo e(route('login')); ?>" class="flex-1 btn btn-ghost text-[10px] font-black uppercase tracking-widest border border-sand-300 text-center">Masuk</a>
                        <a href="<?php echo e(route('register')); ?>" class="flex-1 btn btn-primary text-[10px] font-black uppercase tracking-widest text-center">Daftar</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php /**PATH /home/dini/Sites/seapedia/resources/views/components/navbar.blade.php ENDPATH**/ ?>