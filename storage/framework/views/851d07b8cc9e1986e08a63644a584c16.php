...
<?php foreach($attributes->onlyProps(['product', 'index' => 0, 'bgCard' => false]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['product', 'index' => 0, 'bgCard' => false]); ?>
<?php foreach (array_filter((['product', 'index' => 0, 'bgCard' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<a href="<?php echo e(route('products.show', $product->id)); ?>" class="group block animate-cinematic" style="animation-delay: <?php echo e(100 + ($index * 50)); ?>ms;">
    <div class="flex flex-col h-full <?php echo e($bgCard ? 'bg-white p-3.5 rounded-[16px] border border-sand-200 shadow-sm hover:shadow-warm transition-all duration-300' : ''); ?>">
        ...
        <div class="text-left flex flex-col flex-grow mt-3">
            ...
            <div class="flex items-center gap-1.5 mt-1 mb-2 bg-sand-100/60 px-2 py-1 rounded-[6px] w-fit">
                ...
                <span class="text-xs font-extrabold text-navy-900"><?php echo e(number_format($product->rating ?: 5.0, 1)); ?></span>
                <span class="text-xs text-sand-400">|</span>
                <span class="text-[11px] text-sand-600 font-semibold"><?php echo e(number_format($product->sold_count ?: 0)); ?> terjual</span>
            </div>
...
<?php /**PATH /home/dini/Sites/seapedia/resources/views/components/product-card.blade.php ENDPATH**/ ?>