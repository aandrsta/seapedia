<?php $__env->startSection('title', 'Tambah Produk Baru - SEAPEDIA'); ?>
<?php $__env->startSection('page_title', 'Unggah Produk Jualan'); ?>
...
<div class="max-w-2xl mx-auto">
    <div class="card p-8 bg-white border border-sand-300 shadow-warm">
        ...
        <form action="<?php echo e(route('seller.products.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                          placeholder="Jelaskan kondisi barang, berat, asal tangkapan, dll..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dini/Sites/seapedia/resources/views/dashboard/seller/products/create.blade.php ENDPATH**/ ?>