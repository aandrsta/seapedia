<?php $__env->startSection('title', 'Profil Saya - SEAPEDIA'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="w-full text-left space-y-3">
                        <div>
                            ...
                            <p class="text-xs font-semibold text-navy-800 break-all mt-0.5"><?php echo e($user->email); ?></p>
                        </div>
                        <div>
                    ...
                    <?php if(count($roles) > 1): ?>
                        <div class="w-full mt-6">
                            <a href="<?php echo e(route('select-role')); ?>" class="btn btn-secondary btn-sm w-full font-black tracking-widest text-[9px] py-3 rounded-[10px]">
                                GANTI PERAN AKTIF
                            </a>
                        </div>
                    <?php endif; ?>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="card p-6 bg-white border border-sand-300 shadow-warm rounded-[20px] animate-cinematic delay-200">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 rounded-[14px] bg-teal-50/40 border border-teal-100/80">
                            ...
                            <div class="text-right">
                                <span class="text-sm font-black text-navy-900">
                                    Rp <?php echo e(number_format($user->wallet ? $user->wallet->balance : 0, 0, ',', '.')); ?>

                                </span>
                                <a href="<?php echo e(route('buyer.wallet')); ?>" class="text-[10px] text-teal-600 hover:text-teal-500 font-bold block mt-0.5 underline underline-offset-2 transition-colors">Top-up &amp; Detail</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-4 rounded-[14px] bg-sand-50/50 border border-sand-200/80">
                            ...
                            <div class="text-right">
                                <span class="text-sm font-black text-navy-900">
                                    <?php echo e($user->orders ? $user->orders->count() : 0); ?> Pesanan
                                </span>
                ...
                <?php if(!in_array('seller', $roles) || !in_array('driver', $roles)): ?>
                    <div class="w-100 animate-cinematic delay-300">
                        <div class="card p-6 bg-gradient-to-br from-navy-900 to-navy-950 text-white rounded-[20px] relative overflow-hidden shadow-warm-lg border border-navy-800">
                            ...
                            <div class="relative z-10 space-y-4">
                                ...
                                <a href="<?php echo e(route('profile.partnership')); ?>" class="btn btn-primary inline-flex whitespace-nowrap text-xs font-black tracking-widest py-3 px-6 rounded-[10px] shadow-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dini/Sites/seapedia/resources/views/profile/index.blade.php ENDPATH**/ ?>